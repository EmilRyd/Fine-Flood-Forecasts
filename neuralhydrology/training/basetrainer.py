...
class BaseTrainer(object):
    ...
    def _get_optimizer(self) -> torch.optim.Optimizer:
        return get_optimizer(model=self.model, cfg=self.cfg, tune_attributes=True, attributes=self.ds._attributes)
    ...
    def initialize_training(self):
        ...
        if self.cfg.checkpoint_path is not None:
            ...
            self.model.load_state_dict(torch.load(str(checkpoint_path), map_location=self.device, weights_only=True))
    ...
    def _create_folder_structure(self):
        ...
        # create as new folder structure
            ...
            run_name = f'{self.cfg.experiment_name}'
